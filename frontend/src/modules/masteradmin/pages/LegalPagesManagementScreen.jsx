...
export default function LegalPagesManagementScreen() {
    ...
    const [terms, setTerms] = useState({ content: '', email: '', phone: '' });
    ...
    const saveSection = async (section) => {
        let payload = {};
        if (section === 'terms') payload = { ...terms };
                            ...
                            <>
                                <label className="block space-y-2">
                                    ...
                                    <input
                                        type="email"
                                        value={terms.email}
                                        onChange={(e) => setTerms((t) => ({ ...t, email: e.target.value }))}
                                ...
                                <label className="block space-y-2">
                                    ...
                                    <input
                                        type="text"
                                        value={terms.phone}
                                        onChange={(e) => setTerms((t) => ({ ...t, phone: e.target.value }))}
                                        className="w-full border border-slate-200 rounded-md px-3 py-2 text-sm"
                                        placeholder="+91 …"
                                    />
                                </label>
                                <label className="block space-y-2">
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                                        Terms content (plain text or simple paragraphs)
                                    </span>
                                    <textarea
                                        value={terms.content}
